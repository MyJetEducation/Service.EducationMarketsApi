...
using Service.WalletApi.EducationMarketsApi.Modules;

namespace Service.WalletApi.EducationMarketsApi
{
	public class Startup
	{
		...
		{
			StartupUtils.SetupWalletApplication(app, env, Program.Settings.EnableApiTrace, "education/markets");
