...
using Service.EducationMarketsApi.Mappers;
using Service.EducationMarketsApi.Models;
using Service.Grpc;
using Service.TutorialMarkets.Grpc;
using Service.TutorialMarkets.Grpc.Models.State;
using Service.Web;

namespace Service.EducationMarketsApi.Controllers
{
	[Route("/api/v1/education/markets")]
	public class EducationController : BaseController
	{
		private readonly IGrpcServiceProxy<ITutorialMarketsService> _tutorialService;

		public EducationController(IGrpcServiceProxy<ITutorialMarketsService> tutorialService,
