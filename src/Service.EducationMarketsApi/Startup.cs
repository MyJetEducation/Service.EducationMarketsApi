...
using Service.EducationMarketsApi.Modules;
using Service.Web;
using SimpleTrading.ServiceStatusReporterConnector;

namespace Service.EducationMarketsApi
{
	public class Startup
	{
		private const string DocumentName = "education/markets";
		private const string ApiName = "EducationMarketsApi";
